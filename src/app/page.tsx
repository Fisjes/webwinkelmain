...
export default function Home() {
  return (
    <div>
      ...
      <div className="grid justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 blocks p-10 w-full h-auto">
          <div className="p-10 justify-center items-center w-auto h-auto bg-gradient-to-br from-blue-950 from-10% to-stone-950 rounded-2xl relative">
            <h1 className="text-4xl text-white font-bold">Welcome! We are Artoller.</h1>
          ...
          <div className="w-auto h-auto p-10 rounded-2xl bg-gradient-to-b from-blue-950 from-0% to-stone-950 relative">
          ...
          <div className="w-auto p-10 h-auto rounded-2xl bg-gradient-to-bl from-blue-950 from-10% to-stone-950 relative">
  ...
  <span className="marquee text-2xl font-bold text-white">
    ...
    20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 20% OFF WITH REFERRAL CODE "BTMC" 
      ...
      {/* newsletter */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2 blocks p-10 w-full h-auto">
          <div className="w-auto h-auto p-10 rounded-2xl bg-gradient-to-b from-blue-950 from-0% to-stone-950 relative">
          ...
          <div className="p-10 justify-center items-center w-auto h-auto bg-gradient-to-br from-blue-950 from-10% to-stone-950 rounded-2xl relative">
            <h1 className="text-4xl text-white font-bold">Anyone can use our controllers!</h1>
          ...
          <div className="w-auto p-10 h-auto rounded-2xl bg-gradient-to-bl from-yellow-950 from-10% to-stone-950 relative">
            ...
            <p className="text-white font-medium text-xl mt-5">We are partnering with <span className="text-blue-500 font-bold">BTMC</span>, the popular Osu! Youtuber and former top player in the Osu! Community.</p>          </div>
          <div className="w-auto p-10 h-auto rounded-2xl bg-gradient-to-bl from-blue-950 from-10% to-stone-950 relative">

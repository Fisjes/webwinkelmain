...
export default function Home() {
  return (
    <div>
      {/* nav bar */}
      <div className="navbar font-bold text-white text-2xl w-full h-30 flex justify-center gap-10">
      ...
      <div className="p-10 w-full flex justify-center ">
        <div className="grid gap-5 grid-rows-[auto,auto,auto,auto,auto] w-200 text-center items-center">
          <h1 className="text-white font-bold text-6xl">The <span className="text-blue-500">ArtollerV2</span></h1>
      ...
      <div className="flex gap-2 blocks p-10 w-full h-auto">
          ...
          <div className="w-150 p-10 h-100 rounded-2xl bg-gradient-to-bl from-blue-950 from-10% to-stone-950 relative">
            ...
            <p className="text-white font-medium text-xl mt-5">We are partnering with <span className="italic">BTMC</span>, the imfamous Osu! Youtuber and former top player in the Osu! Community.</p>
